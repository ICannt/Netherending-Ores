...
public class BlockOreNetherVanilla extends BlockVariantBase {
    ...
    public void initClient() {
        ModelLoader.setCustomMeshDefinition(Item.getItemFromBlock(this), stack -> {
            ...
            EnumOreVanillaType composite = EnumOreVanillaType.values()[meta];
            ...
            return variants.get(BlockOreNetherVanilla.this.getDefaultState().withProperty(VARIANT, composite));
        });
    }
}
