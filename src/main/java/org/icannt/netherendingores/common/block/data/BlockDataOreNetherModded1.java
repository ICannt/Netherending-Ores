...
public enum BlockDataOreNetherModded1 implements IStringSerializable {
    ...
    IRIDIUM_ORE ("iridium_ore", 4, 3, 3, 15, EnumRarity.UNCOMMON, -1),
    LEAD_ORE ("lead_ore", 0, 2, 3, 15, EnumRarity.COMMON, -1),
    MITHRIL_ORE ("mithril_ore", 8, 3, 3, 15, EnumRarity.RARE, -1),
    NICKEL_ORE ("nickel_ore", 0, 2, 3, 15, EnumRarity.COMMON, -1),
    PLATINUM_ORE ("platinum_ore", 4, 3, 3, 15, EnumRarity.UNCOMMON, -1),
    SILVER_ORE ("silver_ore", 4, 2, 3, 15, EnumRarity.COMMON, -1),
    ...
    BlockDataOreNetherModded1(String name, int light, int harvestLevel, float hardness, float resistance, EnumRarity rarity, int blockRecipeDataOrdinal) {
