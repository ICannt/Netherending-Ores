...
public enum EnumOreNetherVanillaType implements IStringSerializable {
    ...
    COAL_ORE ("coal_ore", 0, 0, 3, 15, EnumRarity.COMMON, "oreEndCoal", "mc_coal", "oreCoal", 2, 0),
    DIAMOND_ORE ("diamond_ore", 0, 2, 3, 15, EnumRarity.COMMON, "oreEndDiamond", "gemDiamond", "oreDiamond", 2, 0),
    EMERALD_ORE ("emerald_ore", 0, 2, 3, 15, EnumRarity.COMMON, "oreEndEmerald", "gemEmerald", "oreEmerald", 2, 0),
    ...
    LAPIS_ORE ("lapis_ore", 0, 1, 3, 15, EnumRarity.COMMON, "oreEndLapis", "gemLapis", "oreLapis", 2, 0),
    REDSTONE_ORE ("redstone_ore", 0, 1, 3, 15, EnumRarity.COMMON, "oreEndRedstone", "dustRedstone", "oreRedstone", 2, 0);
