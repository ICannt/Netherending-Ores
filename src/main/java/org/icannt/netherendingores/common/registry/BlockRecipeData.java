...
public enum BlockRecipeData implements IStringSerializable {
    ...
    END_RUBY_ORE ("end_ruby_ore", "ore_end_modded_2", 0, new String[0], "", true, 2, 0),
    END_SAPPHIRE_ORE ("end_sapphire_ore", "ore_end_modded_2", 0, new String[0], "", true, 2, 0),
    END_PERIDOT_ORE ("end_peridot_ore", "ore_end_modded_2", 0, new String[0], "", true, 2, 0),
    END_ELECTROTINE_ORE ("end_electrotine_ore", "ore_end_modded_2", 0, new String[0], "", true, 2, 0),
    END_AMBROSIUM_ORE ("end_ambrosium_ore", "ore_end_modded_2", 0, new String[0], "", true, 2, 0),
    END_GRAVITITE_ORE ("end_gravitite_ore", "ore_end_modded_2", 0, new String[0], "", true, 2, 0),
    END_ZANITE_ORE ("end_zanite_ore", "ore_end_modded_2", 0, new String[0], "", true, 2, 0),
    END_ARKENIUM_ORE ("end_arkenium_ore", "ore_end_modded_2", 0, new String[0], "", true, 2, 0),
    END_ICESTONE_ORE ("end_icestone_ore", "ore_end_modded_2", 0, new String[0], "", true, 2, 0),
    ...
    NETHER_RUBY_ORE ("nether_ruby_ore", "ore_nether_modded_2", 0, new String[0], "", true, 2, 0),
    NETHER_SAPPHIRE_ORE ("nether_sapphire_ore", "ore_nether_modded_2", 0, new String[0], "", true, 2, 0),
    NETHER_PERIDOT_ORE ("nether_peridot_ore", "ore_nether_modded_2", 0, new String[0], "", true, 2, 0),
    NETHER_ELECTROTINE_ORE ("nether_electrotine_ore", "ore_nether_modded_2", 0, new String[0], "", true, 2, 0),
    NETHER_AMBROSIUM_ORE ("nether_ambrosium_ore", "ore_nether_modded_2", 0, new String[0], "", true, 2, 0),
    NETHER_GRAVITITE_ORE ("nether_gravitite_ore", "ore_nether_modded_2", 0, new String[0], "", true, 2, 0),
    NETHER_ZANITE_ORE ("nether_zanite_ore", "ore_nether_modded_2", 0, new String[0], "", true, 2, 0),
    NETHER_ARKENIUM_ORE ("nether_arkenium_ore", "ore_nether_modded_2", 0, new String[0], "", true, 2, 0),
    NETHER_ICESTONE_ORE ("nether_icestone_ore", "ore_nether_modded_2", 0, new String[0], "", true, 2, 0),
    ...
    OVERWORLD_AMBROSIUM_ORE ("overworld_ambrosium_ore", "ore_other_1", 5, new String[0], "", true, 1, 0),
    OVERWORLD_GRAVITITE_ORE ("overworld_gravitite_ore", "ore_other_1", 5, new String[0], "", true, 1, 0),
    OVERWORLD_ZANITE_ORE ("overworld_zanite_ore", "ore_other_1", 5, new String[0], "", true, 1, 0),
    OVERWORLD_ARKENIUM_ORE ("overworld_arkenium_ore", "ore_other_1", 5, new String[0], "", true, 1, 0),
    OVERWORLD_ICESTONE_ORE ("overworld_icestone_ore", "ore_other_1", 5, new String[0], "", true, 1, 0);
