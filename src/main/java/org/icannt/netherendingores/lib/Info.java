...
public class Info {
    ...
    public static final String CLIENT_PROXY = "org.icannt.netherendingores.proxy.ClientProxy";
    public static final String SERVER_PROXY = "org.icannt.netherendingores.proxy.ServerProxy";
