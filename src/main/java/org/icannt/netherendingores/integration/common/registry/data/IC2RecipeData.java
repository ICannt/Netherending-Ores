...
public enum IC2RecipeData implements IStringSerializable {
    ...
    NETHER_LAPIS_ORE ("nether_lapis_ore", 25, 4, 8, 3),
    NETHER_REDSTONE_ORE ("nether_redstone_ore", 15, 4, 8, 3),
    ...
    END_LAPIS_ORE ("end_lapis_ore", 25, 4, 8, 3),
    END_REDSTONE_ORE ("end_redstone_ore", 15, 4, 8, 3),
