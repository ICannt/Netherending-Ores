...
public enum SmeltRecipe implements IStringSerializable {
    ...
    NETHER_GOLD_ORE ("nether_gold_ore", false, true, 144, 4, 8),
    NETHER_IRON_ORE ("nether_iron_ore", false, true, 144, 4, 8),
    NETHER_LAPIS_ORE ("nether_lapis_ore", false, false, 0, 0, 0),
    NETHER_REDSTONE_ORE ("nether_redstone_ore", false, false, 0, 0, 0),
    END_COAL_ORE ("end_coal_ore", false, false, 144, 4, 8),
    END_DIAMOND_ORE ("end_diamond_ore", false, false, 144, 4, 8),
    END_EMERALD_ORE ("end_emerald_ore", true, true, 666, 4, 8),
    END_GOLD_ORE ("end_gold_ore", true, true, 144, 4, 8),
    END_IRON_ORE ("end_iron_ore", true, true, 144, 4, 8),
    END_LAPIS_ORE ("end_lapis_ore", false, false, 0, 0, 0),
    END_REDSTONE_ORE ("end_redstone_ore", false, false, 0, 0, 0),
    NETHER_ALUMINUM_ORE ("nether_aluminum_ore", false, true, 144, 4, 8),
    NETHER_COPPER_ORE ("nether_copper_ore", false, true, 144, 4, 8),
    NETHER_IRIDIUM_ORE ("nether_iridium_ore", false, true, 144, 4, 8),
    NETHER_LEAD_ORE ("nether_lead_ore", false, true, 144, 4, 8),
    NETHER_MITHRIL_ORE ("nether_mithril_ore", false, false, 144, 4, 8),
    NETHER_NICKEL_ORE ("nether_nickel_ore", false, true, 144, 4, 8),
    NETHER_PLATINUM_ORE ("nether_platinum_ore", false, true, 144, 4, 8),
    NETHER_SILVER_ORE ("nether_silver_ore", false, true, 144, 4, 8),
    NETHER_TIN_ORE ("nether_tin_ore", false, true, 144, 4, 8),
    ...
    NETHER_OSMIUM_ORE ("nether_osmium_ore", false, true, 144, 4, 8),
    NETHER_URANIUM_ORE ("nether_uranium_ore", false, false, 0, 0, 0),
    NETHER_YELLORITE_ORE ("nether_yellorite_ore", false, false, 0, 0, 0),
    END_ALUMINUM_ORE ("end_aluminum_ore", true, true, 144, 4, 8),
    END_COPPER_ORE ("end_copper_ore", true, true, 144, 4, 8),
    END_IRIDIUM_ORE ("end_iridium_ore", true, true, 144, 4, 8),
    END_LEAD_ORE ("end_lead_ore", true, true, 144, 4, 8),
    END_MITHRIL_ORE ("end_mithril_ore", false, false, 144, 4, 8),
    END_NICKEL_ORE ("end_nickel_ore", true, true, 144, 4, 8),
    END_PLATINUM_ORE ("end_platinum_ore", true, true, 144, 4, 8),
    END_SILVER_ORE ("end_silver_ore", true, true, 144, 4, 8),
    END_TIN_ORE ("end_tin_ore", true, true, 144, 4, 8),
    ...
    END_OSMIUM_ORE ("end_osmium_ore", true, true, 144, 4, 8),
    ...
    OVERWORLD_ARDITE_ORE ("overworld_ardite_ore", true, true, 144, 4, 8),
    END_ARDITE_ORE ("end_ardite_ore", true, true, 144, 4, 8),
    OVERWORLD_COBALT_ORE ("overworld_cobalt_ore", true, true, 144, 4, 8),
    END_COBALT_ORE ("end_cobalt_ore", true, true, 144, 4, 8);
